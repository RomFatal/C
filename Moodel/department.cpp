...
Department::Department(string departmentName)
	:departmentName(departmentName), coursesList(0), studentsList(0) {}
...
RCPtr<Student>& Department::addStudent(const string fName, const string lName, const int ID, const int rYear, const string studAd, const string dep, const int sumOfCred) {
...
void Department::signUpCourse(const int Id, const int courseId) {
...
bool Department::isExist(const int Id) {
...
void Department::deleteStudent(const int Id) {
	if (studentsList == 0)
		return;
